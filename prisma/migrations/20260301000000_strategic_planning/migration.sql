...
CREATE TABLE IF NOT EXISTS "strategic_plans" (
  ...
  "department_id" TEXT NOT NULL UNIQUE REFERENCES "departments"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  "name" TEXT NOT NULL,
  "description" TEXT,
  "vision" TEXT,
  "mission" TEXT,
  ...
  "owner_user_id" TEXT REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS "strategic_periods" (
  "id" TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
  "plan_id" TEXT NOT NULL REFERENCES "strategic_plans"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  "label" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "strategic_objectives" (
  "id" TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
  "goal_id" TEXT NOT NULL REFERENCES "strategic_goals"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  "number" INTEGER NOT NULL,
  "title" TEXT NOT NULL,
  "sort_order" INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS "strategic_programs" (
  "id" TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
  "objective_id" TEXT NOT NULL REFERENCES "strategic_objectives"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  "code" TEXT NOT NULL,
  "title" TEXT NOT NULL,
  "description" TEXT,
...
CREATE TABLE IF NOT EXISTS "program_checklist_items" (
  "id" TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
  "program_id" TEXT NOT NULL REFERENCES "strategic_programs"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  "text" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "program_kpi_links" (
  "id" TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
  "program_id" TEXT NOT NULL REFERENCES "strategic_programs"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  "kpi_id" TEXT NOT NULL REFERENCES "kpis"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  "coverage_label" TEXT,
...
CREATE TABLE IF NOT EXISTS "program_period_targets" (
  "id" TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
  "program_id" TEXT NOT NULL REFERENCES "strategic_programs"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  "period_id" TEXT NOT NULL REFERENCES "strategic_periods"("id") ON DELETE CASCADE ON UPDATE CASCADE,
