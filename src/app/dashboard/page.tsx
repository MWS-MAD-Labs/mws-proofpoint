...
function DashboardContent() {
  ...
  const actionCards = [
    ...
    },
    {
      ...
      description: "Author and track 5-year department strategy",
      icon: Target,
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div
        className="fixed bottom-[20%] left-[5%] w-80 h-80 bg-primary/10 rounded-full blur-3xl pointer-events-none animate-float"
              ...
              >
                ...
                <CardHeader className="relative">
                  <div className="flex items-center justify-between">
                    <div
                      className={`w-12 h-12 rounded-xl bg-background/80 border border-border/50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                    >
              ...
              <div>
                ...
                <CardDescription>
                  {isManager || isAdmin || isDirector
                    ? "Latest evaluations across your organization"
