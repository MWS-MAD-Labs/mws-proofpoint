...
export function AdminAssessmentReview() {
  ...
  const handleRelease = async (id: string) => {
    ...
    if (error) {
      ...
      toast({
        title: "Success",
        description:
          "Assessment released successfully. Workflow can now proceed to acknowledgment.",
      });
      // Refresh list
      fetchAssessments();
    }
  ...
  const handleCopyTable = async () => {
    ...
    try {
      ...
      toast({
        title: "Copied!",
        description:
          "Table copied to clipboard. You can paste it directly into Google Docs.",
      });
  ...
  return (
    <>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Review and release finalized assessments.
              </CardDescription>
            </div>
      ...
      <AlertDialog
        open={showReleaseAllConfirm}
        onOpenChange={setShowReleaseAllConfirm}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Release All Assessments?</AlertDialogTitle>
            <AlertDialogDescription>
              This will release all {assessments.length} pending assessment(s)
              at once. Staff members will be notified and can proceed to
              acknowledgment.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel disabled={processingReleaseAll}>
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction
